package com.fortaleza.appfortaleza.client;
...
import com.fortaleza.appfortaleza.LoginActivity;
...
public class MapsclientActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Ubicacion del Distribuidor");
    ...
    //Validacion para los permisos de ubicacion
    @Override
    ...
    //Validacion si el usuario no concedio los permisos
    ...
    void logout() throws LoginException {
        ...
        Intent intent = new Intent(MapsclientActivity.this, LoginActivity.class);
